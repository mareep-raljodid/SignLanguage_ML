...
add.
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "QuantizedMatMulWithBias", name, _ctx._post_execution_callbacks, a, b,
...
add and relu fusion.
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._context_handle, _ctx._thread_local_data.device_name,
        "QuantizedMatMulWithBiasAndRelu", name,
        _ctx._post_execution_callbacks, a, b, bias, min_a, max_a, min_b,
        max_b, "Toutput", Toutput, "transpose_a", transpose_a, "transpose_b",
  ...
  if _ctx is not None and _ctx._thread_local_data.is_eager:
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        ...
        _ctx._post_execution_callbacks, a, b, bias, min_a, max_a, min_b,
        max_b, min_freezed_output, max_freezed_output, "Toutput", Toutput,
        "transpose_a", transpose_a, "transpose_b", transpose_b,
        "input_quant_mode", input_quant_mode)
