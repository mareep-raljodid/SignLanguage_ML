...
def TFE_ContextClearExecutorForThread(arg1):
    return _pywrap_tensorflow_internal.TFE_ContextClearExecutorForThread(arg1)
TFE_ContextClearExecutorForThread = _pywrap_tensorflow_internal.TFE_ContextClearExecutorForThread
